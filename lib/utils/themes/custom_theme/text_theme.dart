...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall:  const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.3)),
  );

  //! customize darkTheme text 
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall:  const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.3)),
  );
}